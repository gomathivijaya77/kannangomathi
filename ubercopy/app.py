...
# 🔥 GET DATABASE URL
db_url = os.getenv("mysql://root:yCjpZuivNglkBsXGBXSYmfBhDKtHhjWI@crossover.proxy.rlwy.net:44018/railway")

# 👉 fallback for local testing (IMPORTANT)
if not db_url:
    db_url = "mysql://root:yCjpZuivNglkBsXGBXSYmfBhDKtHhjWI@crossover.proxy.rlwy.net:44018/railway"
